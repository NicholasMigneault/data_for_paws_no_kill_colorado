with dogs as (
    select
        ...
        ,adult_dogs_in_shelter_count_as_of_1_1_2018                         as start_of_year_in_shelter_count
        ,adult_dogs_in_foster_care_count_1_1_2018                           as start_of_year_in_foster_care_count
        ...
        ,adult_dogs_returned_to_owner_rtox                                  as outcome_return_to_owner
        ...
        ,adult_dogs_other_live_outcomes_ie_tnr_snrx                         as outcome_other
        ...
        ,adult_dogs_in_shelter_count_as_of_12_31_2018                       as end_of_year_in_shelter_count
        ,adult_dogs_in_foster_care_count_12_31_2018                         as end_of_year_in_foster_care_count
    ...
    select
        ...
        ,juvenile_dogs_in_shelter_count_as_of_1_1_2018                      as start_of_year_in_shelter_count
        ,juvenile_dogs_in_foster_care_count_1_1_2018                        as start_of_year_in_foster_care_count
        ...
        ,juvenile_dogs_returned_to_owner_rtox                               as outcome_return_to_owner
        ...
        ,juvenile_dogs_other_live_outcomes_ie_tnr_snrx                      as outcome_other
        ...
        ,juvenile_dogs_in_shelter_count_as_of_12_31_2018                    as end_of_year_in_shelter_count
        ,juvenile_dogs_in_foster_care_count_12_31_2018                      as end_of_year_in_foster_care_count
    from {{ ref('src_google_sheets__2018_statistics') }}
)
, cats as (
    select
        ...
        ,'adult' as animal_type
        ,adult_cats_in_shelter_count_as_of_1_1_2018                         as start_of_year_in_shelter_count
        ,adult_cats_in_foster_care_count_1_1_2018                           as start_of_year_in_foster_care_count
        ...
        ,adult_cats_returned_to_owner_rtox                                  as outcome_return_to_owner
        ...
        ,adult_cats_other_live_outcomes_ie_tnr_snrx                         as outcome_other
        ...
        ,adult_cats_in_shelter_count_as_of_12_31_2018                       as end_of_year_in_shelter_count
        ,adult_cats_in_foster_care_count_12_31_2018                         as end_of_year_in_foster_care_count
    from {{ ref('src_google_sheets__2018_statistics') }}
    union
    select
        facility_name
        ,'cat' as animal_category
        ,'juvenile' as animal_type
        ,juvenile_cats_in_shelter_count_as_of_1_1_2018                      as start_of_year_in_shelter_count
        ,juvenile_cats_in_foster_care_count_1_1_2018                        as start_of_year_in_foster_care_count
        ...
        ,juvenile_cats_returned_to_owner_rtox                               as outcome_return_to_owner
        ...
        ,juvenile_cats_other_live_outcomes_ie_tnr_snrx                      as outcome_other
        ...
        ,juvenile_cats_in_shelter_count_as_of_12_31_2018                    as end_of_year_in_shelter_count
        ,juvenile_cats_in_foster_care_count_12_31_2018                      as end_of_year_in_foster_care_count
    from {{ ref('src_google_sheets__2018_statistics') }}
)
, other as (
    select
        ...
        ,birds_in_shelter_count_as_of_1_1_2018                      as start_of_year_in_shelter_count
        ,birds_in_foster_care_count_1_1_2018                        as start_of_year_in_foster_care_count
        ...
        ,birds_returned_to_owner_rtox                               as outcome_return_to_owner
        ...
        ,birds_other_live_outcomes_ie_tnr_snrx                      as outcome_other
        ...
        ,birds_in_shelter_count_as_of_12_31_2018                    as end_of_year_in_shelter_count
        ,birds_in_foster_care_count_12_31_2018                      as end_of_year_in_foster_care_count
    from {{ ref('src_google_sheets__2018_statistics') }}
    union
    select
        facility_name
        ...
        ,small_mammal_in_shelter_count_as_of_1_1_2018                   as start_of_year_in_shelter_count
        ,small_mammal_in_foster_care_count_1_1_2018                     as start_of_year_in_foster_care_count
        ...
        ,sm_mammal_returned_to_owner_rtox                               as outcome_return_to_owner
        ...
        ,sm_mammal_other_live_outcomes_ie_tnr_snrx                      as outcome_other
        ...
        ,sm_mammal_in_shelter_count_as_of_12_31_2018                    as end_of_year_in_shelter_count
        ,sm_mammal_in_foster_care_count_as_of_12_31_2018                as end_of_year_in_foster_care_count
    from {{ ref('src_google_sheets__2018_statistics') }}
    union
    select
        facility_name
        ...
        ,reptiles_amphibians_in_shelter_count_as_of_1_1_2018                        as start_of_year_in_shelter_count
        ,reptiles_amphibians_in_foster_care_count_1_1_2018                          as start_of_year_in_foster_care_count
        ...
        ,reptiles_amphibians_returned_to_owner_rtox                                 as outcome_return_to_owner
        ...
        ,reptiles_amphibians_other_live_outcomes_ie_tnr_snrx                        as outcome_other
        ...
        ,reptiles_amphibians_in_shelter_count_as_of_12_31_2018                      as end_of_year_in_shelter_count
        ,reptiles_amphibians_in_foster_care_count_as_of_12_31_2018                  as end_of_year_in_foster_care_count
    from {{ ref('src_google_sheets__2018_statistics') }}
    union
    select
        facility_name
        ...
        ,rabbits_in_shelter_count_as_of_1_1_2018                        as start_of_year_in_shelter_count
        ,rabbits_in_foster_care_count_1_1_2018                          as start_of_year_in_foster_care_count
        ...
        ,rabbits_returned_to_owner_rtox                                 as outcome_return_to_owner
        ...
        ,rabbits_other_live_outcomes_ie_tnr_snrx                        as outcome_other
        ...
        ,rabbits_in_shelter_count_as_of_12_31_2018                      as end_of_year_in_shelter_count
        ,rabbits_in_foster_care_count_as_of_12_31_2018                  as end_of_year_in_foster_care_count
    from {{ ref('src_google_sheets__2018_statistics') }}
    union
    select
        facility_name
        ...
        ,other_in_shelter_count_as_of_1_1_2018                  as start_of_year_in_shelter_count
        ,other_in_foster_care_count_1_1_2018                    as start_of_year_in_foster_care_count
        ...
        ,other_returned_to_owner_rtox                           as outcome_return_to_owner
        ...
        ,other_other_live_outcomes_ie_tnr_snrx                  as outcome_other
        ...
        ,other_in_shelter_count_as_of_12_31_2018                as end_of_year_in_shelter_count
        ,other_in_foster_care_count_as_of_12_31_2018            as end_of_year_in_foster_care_count
    from {{ ref('src_google_sheets__2018_statistics') }}
)
, consolidated as (
    select *
...
,final as (
    select '2018' as year
        ,make_date(2018,1,1) as start_of_year_date
        ,make_date(2018,12,31) as end_of_year_date
        ,*
    from consolidated
    where not (
...
--adult_dogs_owner_requested_euthanasia
--juvenile_dogs_owner_requested_euthanasia
--adult_cats_owner_requested_euthanasia
--juvenile_cats_owner_requested_euthanasia
--birds_owner_requested_euthanasia
--sm_mammal_owner_requested_euthanasia
--reptiles_amphibians_owner_requested_euthanasia
--rabbits_owner_requested_euthanasia
--other_owner_requested_euthanasia