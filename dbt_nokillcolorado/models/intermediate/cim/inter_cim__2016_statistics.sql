...
with dogs as (
    select
        ...
        ,adult_dogs_beginning_count                                         as start_of_year_in_shelter_count
        ,adult_dogs_beginning_foster_count                                  as start_of_year_in_foster_care_count
        ...
        ,adult_dogs_transfer_or_rescue_out_to_another_colorado_organization as outcome_in_state_transfer
    ...
    select
        ...
        ,juvenile_dogs_beginning_count                                          as start_of_year_in_shelter_count
        ,juvenile_dogs_beginning_foster_count                                   as start_of_year_in_foster_care_count
        ...
        ,juvenile_dogs_transfer_or_rescue_out_to_another_colorado_organization  as outcome_in_state_transfer
...
, cats as (
    select
        ...
        ,'adult' as animal_type
        ,adult_cats_beginning_count                                         as start_of_year_in_shelter_count
        ,adult_cats_beginning_foster_count                                  as start_of_year_in_foster_care_count
        ...
        ,adult_cats_transfer_or_rescue_out_to_another_colorado_organization as outcome_in_state_transfer
    ...
    select
        ...
        ,'cat' as animal_category
        ,'juvenile' as animal_type
        ,juvenile_cats_beginning_count                                          as start_of_year_in_shelter_count
        ,juvenile_cats_beginning_foster_count                                   as start_of_year_in_foster_care_count
        ...
        ,juvenile_cats_transfer_or_rescue_out_to_another_colorado_organization  as outcome_in_state_transfer
...
, other as (
    select
        ...
        ,birds_beginning_count                                          as start_of_year_in_shelter_count
        ,birds_beginning_foster_count                                   as start_of_year_in_foster_care_count
        ...
        ,birds_transfer_or_rescue_out_to_another_colorado_organization  as outcome_in_state_transfer
    ...
    select
        ...
        ,small_mammal_beginning_count                                       as start_of_year_in_shelter_count
        ,small_mammal_beginning_foster_count                                as start_of_year_in_foster_care_count
        ...
        ,sm_mammal_transfer_or_rescue_out_to_another_colorado_organization  as outcome_in_state_transfer
    ...
    select
        ...
        ,reptiles_beginning_count                                           as start_of_year_in_shelter_count
        ,reptiles_beginning_foster_count                                    as start_of_year_in_foster_care_count
        ,reptiles_stray                                                     as intake_stray
        ,total_reptiles_owner_relinquished                                  as intake_relinquished
        ,reptiles_transfer_in_from_another_colorado_organization            as intake_in_state_transfer
        ,reptiles_transfer_in_from_out_of_state_organization                as intake_out_of_state_transfer
        ,reptiles_other_tnr_protective_custody_returns_disaster_relief      as intake_other
        ,reptiles_adoption                                                  as outcome_adoption
        ,reptiles_returned_to_owner_rto                                     as outcome_return_to_owner
        ,reptiles_transfer_or_rescue_out_to_another_colorado_organization   as outcome_in_state_transfer
        ...
        ,reptiles_shelter_euthanasia                                        as outcome_euthanasia
    ...
    select
        ...
        ,rabbits_beginning_count                                            as start_of_year_in_shelter_count
        ,rabbits_beginning_foster_count                                     as start_of_year_in_foster_care_count
        ...
        ,rabbits_transfer_or_rescue_out_to_another_colorado_organization    as outcome_in_state_transfer
        ...
        ,rabbits_ending_count                                               as end_of_year_in_shelter_count
        ,rabbits_foster_count                                               as end_of_year_in_foster_care_count
    from {{ ref('src_cim__2016_statistics') }}
    union
    select
        facility_name
        ...
        ,other_beginning_count                                          as start_of_year_in_shelter_count
        ,other_beginning_foster_count                                   as start_of_year_in_foster_care_count
        ...
        ,other_transfer_or_rescue_out_to_another_colorado_organization  as outcome_in_state_transfer
...
,final as (
    select '2016' as year
        ,make_date(2016,1,1) as start_of_year_date
        ,make_date(2016,12,31) as end_of_year_date
        ,*
    from consolidated
    where not (
